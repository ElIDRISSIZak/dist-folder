...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_7__tasks_tasks_component__["a" /* TaskComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */],
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormsModule */] // <-Add HttpModule
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_5__data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_6__tasks_task_service__["a" /* TaskService */]],
...
/***/ "../../../../../src/app/tasks/task.component.html":
/***/ (function(module, exports) {

module.exports = "\r\n<div class=\"task-list\">\r\n  <h1>List of Tasks!</h1>\r\n  <form class=\"well\" (submit) = addTask($event)>\r\n    <div class=\"form-group\">\r\n      <input type=\"text\" class=\"form-group\" [(ngModel)] = \"desc\" name=\"desc\" placeholder=\"Add Task\" required size=\"150px\">  \r\n    </div>  \r\n  </form>    \r\n        <table class=\"table\">\r\n            <thead class=\"thead-inverse\">\r\n              <tr>\r\n                <th>-</th>\r\n                <th>tache</th>\r\n                <th>Description</th>\r\n                <th>Editer</th>                \r\n                <th>Supprimer</th>\r\n              </tr>\r\n            </thead>\r\n            <tbody>\r\n              <tr *ngFor=\"let task of tasks\">\r\n                <th scope=\"row\"><input type=\"checkbox\"></th>\r\n                <td>{{task._id }}</td>\r\n                <td>{{task.desc}}</td>\r\n                <td><button type=\"button\" class=\"btn btn-success\">Edit</button></td>\r\n                <td><button type=\"button\" class=\"btn btn-danger\" (click) = \"deleteTask(task._id)\" >X</button></td>\r\n              </tr>\r\n              \r\n            </tbody>\r\n          </table>\r\n\r\n  <!-- <ul>\r\n    <li *ngFor=\"let task of tasks\">{{ task.title }} : {{task.desc}}</li>\r\n  </ul>\r\n  <button type=\"button\" class=\"btn btn-link\">Link</button> -->\r\n\r\n</div>\r\n"
...
var TaskComponent = (function () {
    ...
    TaskComponent.prototype.deleteTask = function (id) {
        ...
        this._taskService.deleteTask(id).subscribe(function (data) {
            if (data.n == 1) {
    ...
    TaskComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'task-root',
            template: __webpack_require__("../../../../../src/app/tasks/task.component.html")
        }),
